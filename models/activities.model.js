module.exports = {
	...
	listHorasByUser(id_user, callback) {
		var sql = 'SELECT * from horas WHERE id_utilizador=?';
		global.connection.query(sql, [ id_user ],
	...
	increment(data, callback) {
		var sql = "INSERT INTO horas (actividade,duracao_sessao, inicio_sessao, fim_sessao, mes, semana, id_utilizador) VALUES (?,?,?,?,?,?,?)";
		global.connection.query(
